...
author: Julian
thumbnail: /images/thumbs/2024_1_Code_WhyCSharp/WhyCSharp.jpg
---
...
Some points from me: 
1. It is not harder than Python – C# is a very modern high-level language. Even C# 7, currently used in Revit's .NET Framework, is clear and easy to learn. After coming from Python, you might encounter some annoying things like slicing the lists, but who cares. Personally, I prefer LINQ to Python's list comprehension (BTW I haven’t seen it used much in Python code for Revit API).
...
5. Use of your own classes, as others already mentioned. To it, I will add extension methods - they are so good!
