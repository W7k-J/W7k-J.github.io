...
<em>Select viewports which title lines you want to alter, or when started you will be prompted to do it by the tool. After that, you just need to pick the point.**  

Press Esc to exit.</em> 
